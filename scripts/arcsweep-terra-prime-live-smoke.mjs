...
const page = await request('/apps/arcsweep/'); assert(page.ok, `Arcsweep page failed: ${page.status}`);
...
const worldContext = { schema: 'arcsweep.runtime-world-context/v1', context_id: `terra-prime-smoke-context:${Date.now()}`, identity_anchor: { world_id: 'terra-prime', world_name: 'Terra Prime' }, provenance: { source: 'arcsweep-terra-prime-live-smoke' } };
