...
export const CONSENT_BRANCHES = [
  { id: 'visual', label: 'Visual Bloom', state: 'off', x: 500, y: 115, description: 'Glow, bloom, and visual emphasis only.' },
  ...
  { id: 'logging', label: 'Export / Logging', state: 'off', x: 165, y: 280, description: 'Local notes, exports, or almanac logs.' },
