...
import AssetWatcherPanel from './AssetWatcherPanel.jsx';
...
function CompanionBridgeExtensions() {
  ...
  return <><FlameChannel /><ArtifactBridgePanel /><AssetWatcherPanel /><ThemeStudio theme={theme} onChange={setTheme} /></>;
}
