export const CORE_CAPABILITIES = [
  ...
  'continuity-and-canon-bridge', 'runa-resonance-bridge',
];

export const SITE_CONSTELLATION = Object.freeze([
  { id: 'arcsweep', name: 'Arcsweep', href: '/apps/arcsweep/', role: 'observation, transformation, replay, resonance and world-state instrument', sockets: ['premaqc', 'spiral', 'bifrost', 'resonance', 'holonomy', 'canon', 'replay'] },
  { id: 'glyph-forge', name: 'Glyph Forge', href: '/apps/arcsweep/#glyph-forge', role: 'glyph construction and projection surface', sockets: ['glyph', 'artifact', 'resonance', 'world'] },
  { id: 'living-glyph', name: 'Living Glyph', href: '/apps/arcsweep/#living-glyph', role: 'live glyph state and response surface', sockets: ['glyph', 'premaqc', 'spiral', 'resonance'] },
  { id: 'brush-foundry', name: 'Brush Foundry', href: '/apps/arcsweep/#brush-foundry', role: 'brush and handwritten mark construction', sockets: ['brush', 'glyph', 'artifact'] },
  { id: 'continuity-gate', name: 'Continuity Gate', href: '/apps/arcsweep/#continuity-gate', role: 'continuity and lineage gate', sockets: ['canon', 'lineage', 'world', 'receipt'] },
  { id: 'echo-index', name: 'Echo Index', href: '/apps/arcsweep/#echo-index', role: 'echo and correspondence index', sockets: ['canon', 'resonance', 'world'] },
  { id: 'canon-studio', name: 'Canon Studio', href: '/apps/arcsweep/#canon-studio', role: 'canon ingest, review and world knowledge', sockets: ['canon', 'artifact', 'world', 'provenance'] },
  { id: 'resonance-bridge', name: 'Resonance Bridge', href: '/apps/arcsweep/#resonance-bridge', role: 'cross-system resonance projection', sockets: ['resonance', 'runa', 'glyph', 'storywork'] },
  { id: 'records-room', name: 'Records Room', href: '/apps/arcsweep/#records-room', role: 'rich-text writing, roleplay and records', sockets: ['storywork', 'canon', 'artifact', 'rich-text'] },
  { id: 'replay', name: 'Replay', href: '/apps/arcsweep/#replay', role: 'deterministic receipt and trajectory replay', sockets: ['replay', 'receipt', 'bifrost', 'holonomy'] },
  ...
  { id: 'project-zero', name: 'Project Zero Companion', href: '/apps/project-zero-companion/', role: 'shared companion bridge and constellation dock', sockets: ['all-registered-sockets'] },
]);
...
export const PLUGIN_MANIFESTS = [
  ...
  { id: 'arcsweep-runtime-bridge', name: 'Arcsweep Runtime Bridge', status: 'active-companion-service', purpose: 'Carry Arcsweep PREMAQC, Shared Spiral, Bifrost crossing, Spiral Resonance, Spiral Holonomy, replay and receipt records into the Project Zero Companion event fabric without flattening multidimensional state.', permissions: ['local-event-bus', 'receipt-read'], emits: ['arcsweep.state', 'arcsweep.crossing', 'arcsweep.resonance', 'arcsweep.holonomy'], listens: ['premaqc.update', 'spiral.update', 'bifrost.crossing', 'replay.complete'] },
