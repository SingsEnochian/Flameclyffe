  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        arcsweepReplay: resolve(REPO_ROOT, 'apps/starwell/arcsweep-replay/index.html'),
        echoIndex: resolve(REPO_ROOT, 'apps/starwell/echo-index/index.html'),
        canonStudio: resolve(REPO_ROOT, 'apps/starwell/canon-studio/index.html'),
        brushFoundry: resolve(REPO_ROOT, 'apps/starwell/brush-foundry/index.html'),
        resonanceBridge: resolve(REPO_ROOT, 'apps/starwell/resonance-bridge/index.html'),
