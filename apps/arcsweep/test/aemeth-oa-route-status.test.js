...
test('reachable Supabase relay remains distinct from armed Hugging Face inference', () => {
  ...
  assert.match(visible.summary, /Hugging Face inference credential is missing/i);
});
