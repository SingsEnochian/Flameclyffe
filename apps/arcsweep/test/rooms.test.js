...
test('non-canon ingest is visible, attachment-backed, and uses Steward-gated canon boundaries', () => {
  ...
  assert.deepEqual(boundaryField[4], ['Non-canon source', 'Candidate for Steward review', 'Committed to canon']);
});
