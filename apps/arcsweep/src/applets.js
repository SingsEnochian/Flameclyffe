...
const CORE_APPLETS = [
  ...
  {
    id: 'observer-workbench',
    label: 'Observer Workbench',
    glyph: '⊙',
    category: 'observation',
    defaultVisible: true,
    pagesHref: '/Flameclyffe/apps/arcsweep/observer/',
    webHref: '/arcsweep/observer/',
    organFamily: 'observer',
    organKind: 'external',
    description: 'Merged Observer / DEEP / PREMAQC instrument with semantic health, epistemic ledgers, rich working notes, selective skills, and Boxfire witness receipts.',
    implementation: 'apps/arcsweep/observer/index.html',
  },
