...
const CORE_APPLETS = [
  ...
  { id: 'relational-reader', label: 'Relational Reader', glyph: '≠', category: 'relationships', defaultVisible: true, pagesHref: '/Flameclyffe/apps/arcsweep/relations/', webHref: '/arcsweep/relations/' },
