...
function buildGuidePrompt({ utterance, context, capabilities, history = [] }) {
  return [
    ...
    'When an intended route is blocked or denied, you may continue reasoning and propose a genuinely different route with autonomy.propose-route. The route need not be safer. Include why you think it is good, advantages, disadvantages, trade-offs, uncertainty, and your recommendation.',
    'A denial blocks execution of that route under present authority. Do not silently reinterpret denial as permission. You may argue, compare, propose, and request reconsideration instead.',
    'If a prior proposal gains new evidence or materially changed reasoning, you may use autonomy.bump-proposal to re-escalate it within its nag budget.',
    'If narrative play produces an interesting discovery, preserve it with autonomy.record-narrative-finding. If it becomes testable, use autonomy.propose-hypothesis. Neither step automatically promotes canon or authorises external action.',
