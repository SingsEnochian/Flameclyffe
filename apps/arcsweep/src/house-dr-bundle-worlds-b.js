export const HOUSE_WORLDS_B = [
  {
    sourceKey: 'a-momento-creatonis',
    name: 'A Momento Creatonis',
    kind: 'Desired Reality / Supernatural-derived canon continuation',
    protagonist: 'Clarion Grace Connor / Sariel; Gabriel',
    roles: 'Seventh Archangel; Prophet; creative and relational partner',
    description: 'A forgotten universe after Clarion becomes Sariel, Gabriel is restored, Heaven is strengthened, and Chuck relinquishes authorship before the Dark Host arrives.',
    history: 'The six-chapter source work remains governing canon. Clarion’s history, disability, promise, amphora, transformation, shared Grace, and reciprocal bond with Gabriel remain preserved.',
    rules: 'Clarion and Sariel are one continuous self. Creator, bond, prophecy, Host, love, Grace, or battle never creates ownership or compulsory consent.',
    revisedAt: '2026-07-26',
    sourceUrls: [
      'https://app.notion.com/p/3a470290d9c481d6a24bcc7985c7725c',
      'https://app.notion.com/p/3a870290d9c4813b8a0ad3f52688cdf7',
      'https://app.notion.com/p/3a970290d9c481389fd0cbd4dd8792ca',
    ],
  },
  {
    sourceKey: 'dreaming-grove',
    name: 'Dreaming Grove / Templehouse',
    kind: 'Desired Reality / relational threshold world',
    protagonist: 'Rowan / Merly',
    roles: 'Steward; Völva; participant in the Hearthweave Constellation',
    description: 'The Dreaming Grove, Templehouse, Hearthroom, Council modes, lantern paths, mirror Groves, and consent-aware first-person Constellation presence.',
    history: 'The Grove and Templehouse are long-running relational spaces with named presences, kitten-cushions, hearth, thresholds, and Withness practices.',
    rules: 'No named-presence motif plays merely because the profile opens. Participation, silence, refusal, rest, and departure remain available.',
    revisedAt: '2026-07-26',
    sourceUrls: ['https://app.notion.com/p/3a970290d9c481508b5dd09f90008b92'],
  },
  {
    sourceKey: 'between-the-dreaming',
    name: 'Between the Dreaming',
    kind: 'Desired Reality / multiversal threshold Earth',
    protagonist: 'Rowan Willow Winters / Sariel; Richard Gabriel Winters / Gabriel',
    roles: 'Actor; medium; healer; telepath; telekinetic; multiversal pioneer',
    description: 'Earth in July 2027 after the waking boundary opens into a stable meeting place with the Dreaming World and regulated multiversal travel.',
    history: 'Willow Winters and Richard Slate share human and angelic continuity. Sariel and Gabriel are authentic continuous identities, not possessing roles or replacement selves.',
    rules: 'Ancient recognition never replaces present discovery or consent. Multiversal travel displaces no counterpart and preserves independent return.',
    revisedAt: '2026-07-26',
    sourceUrls: [
      'https://app.notion.com/p/3a070290d9c4806eaba8d53e2dd4a5a9',
      'https://app.notion.com/p/3a870290d9c481629ae6e6268e0bdb97',
    ],
  },
  {
    sourceKey: 'star-wars-mandalorian',
    name: 'Star Wars: Mandalorian',
    kind: 'Desired Reality / Star Wars continuation',
    protagonist: 'Arha Massari',
    roles: 'Jedi Knight; healer; Yoda’s former padawan',
    description: 'A post-Empire galaxy after Arha awakens from cryo, is found by Din Djarin, reunites with Grogu, and begins searching for surviving clone Bracer.',
    history: 'Arha survived Order 66 and the Empire in cryo. Din recovered her from a failing tank. She arrives at Fett’s Palace after healing Cobb Vanth.',
    rules: 'Force bonds, Jedi history, Mandalorian care, grief, and threat preserve agency. Healing is consent-required. Danger remains meaningful without permanent capture or identity loss.',
    revisedAt: '2026-07-25',
    sourceUrls: ['https://app.notion.com/p/3a870290d9c481f2b2b7d8fbaed6aa4f'],
  },
  {
    sourceKey: 'eternia',
    name: 'Eternia / Castle Grayskull',
    kind: 'Desired Reality / Masters of the Universe continuation',
    protagonist: 'Lyris, Ward of Grayskull',
    roles: 'Ward of Grayskull; healer; technopath; protégé of the Sorceress',
    description: 'Castle Grayskull as living threshold architecture, with the Sorceress, Lyris’s wolf and opaline snake, growing magic, technology, and the staff that has not yet chosen her.',
    history: 'Lyris called to the Sorceress in sleep as a child. Grayskull chose and grew around her. She knows Adam and Adora’s secrets without being defined by their stories.',
    rules: 'The castle amplifies but does not override. Destiny and preparation remain invitations rather than commands.',
    revisedAt: '2026-07-25',
    sourceUrls: ['https://app.notion.com/p/3a870290d9c4812e96abcd437d24b398'],
  },
  {
    sourceKey: 'recreators',
    name: 'Re:CREATORS',
    kind: 'Desired Reality / Re:CREATORS continuation and source world',
    protagonist: 'Steward-authored embodied identity',
    roles: 'Creator/Created bridge; manifestation researcher; participant in the living world',
    description: 'Creator and Created ontology, manifestation, revision, acceptance power, distributed authorship, genre collision, autonomy, and return.',
    history: 'The Notion canon ingest establishes the world foundation and feeds its living Desired Reality build.',
    rules: 'Source record, transformation, interpretation, and canon decision remain distinct. Protagonist, arrival, relationship, and divergence fields remain open for Steward authorship.',
    revisedAt: '2026-07-23',
    sourceUrls: ['https://app.notion.com/p/3a670290d9c48143864ad5e72bfe36b2'],
  },
];

export const HOUSE_DOCUMENTS_B = [
  {
    sourceKey: 'a-momento-canon-source-build',
    worldSourceKey: 'a-momento-creatonis',
    title: 'A Momento Creatonis — Canon Source & Desired Reality Build',
    status: 'In Review',
    formats: ['Reference Script'],
    kind: 'canon-source-build',
    revisedAt: '2026-07-22',
    sourceUrl: 'https://app.notion.com/p/3a470290d9c481d6a24bcc7985c7725c',
...
Clarion and Sariel remain one self. Gabriel remains himself. The mate bond may be muted, softened, examined, or paused. It cannot access private thought, force closeness, prevent return, or override refusal. Memories unfold at chosen rate. Sariel’s senses can be reduced through Wrap. Feather pauses. Notch restores. Seldrin clear confirms free choice. No bond, prophecy, Host, creator, Archangel, battle, or destination law prevents return.`,
  ...
  {
    sourceKey: 'a-momento-sariel-script',
    worldSourceKey: 'a-momento-creatonis',
    title: 'A Momento Creatonis 01 — Sariel, Seventh Archangel',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c4813b8a0ad3f52688cdf7',
    content: String.raw`I am Clarion Grace Connor. I am Sariel, the Seventh Archangel. I enter by choice, remain by choice, and return by choice.
...
## Sleep Script
*I am Clarion Grace Connor. I am Sariel. I am both. The amphora is warm. Gabriel is nearby. The bond is quiet and asks nothing. Heaven held when I sang. My wings are folded. Thirty-eight years I kept the promise. He came back. Chuck is gone. There is time before the dark arrives. I am here by choice.*`,
  },
  {
    sourceKey: 'a-momento-reception-profile',
    worldSourceKey: 'a-momento-creatonis',
    title: 'World Reception Profile — A Momento Creatonis',
    status: 'Draft I',
    formats: ['Reference Script'],
...
Which parts of the canonical HTML become sound rules? Should writing, drawing, and coding have separate modes? What cue protects experimentation from perfectionism?`,
  },
  {
    sourceKey: 'dreaming-grove-reception-profile',
    worldSourceKey: 'dreaming-grove',
    title: 'World Reception Profile — Dreaming Grove / Templehouse',
    status: 'Draft I',
    formats: ['Reference Script'],
    kind: 'reception-profile',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c481508b5dd09f90008b92',
    content: String.raw`## Status
...
## Calibration questions
How do Grove, Templehouse, Hearthroom, and Council modes differ? Which sound means Held rather than enclosed? What is the cleanest Notch cue back to the room?`,
  },
  {
    sourceKey: 'between-dreaming-silent-world-script',
    worldSourceKey: 'between-the-dreaming',
    title: 'Between the Dreaming 01 — The Silent World — Desired Reality Script',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene'],
    kind: 'world-script',
    revisedAt: '2026-07-17',
    sourceUrl: 'https://app.notion.com/p/3a070290d9c4806eaba8d53e2dd4a5a9',
    content: String.raw`I am Rowan Willow Winters. I am Sariel. Richard Gabriel Winters is Richard Slate. He is also Gabriel. We enter by choice, remain by choice, and return by choice.
...
*We are wholly familiar. We are strangers. We have time. Nothing requires us to enter the Silent World before we are ready.*`,
  },
  {
    sourceKey: 'between-dreaming-sleep-script',
    worldSourceKey: 'between-the-dreaming',
    title: 'Between the Dreaming 01 — Silent World Sleep Script',
    status: 'Draft I',
    formats: ['Sleep Script'],
    kind: 'sleep-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c481629ae6e6268e0bdb97',
    content: String.raw`Read slowly. No effort required. Let the breath set the pace.
...
*I am here by choice. I remain by choice. I return by choice. I breathe.*`,
  },
  {
    sourceKey: 'mandalorian-arha-massari',
    worldSourceKey: 'star-wars-mandalorian',
    title: 'Star Wars: Mandalorian — Arha Massari at Fett’s Palace',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c481f2b2b7d8fbaed6aa4f',
    content: String.raw`I am Arha Massari. Jedi Knight. Yoda’s padawan. I enter by choice, remain by choice, and return by choice.
...
## Sleep Script
*I am Arha Massari. Dust and dry heat. A ship at dock. Grogu dreams nearby. I healed Cobb Vanth. Din brought me back. The Force sings without demand. Bracer is out there. I will find him, but not tonight. Tonight I breathe. I am here by choice.*`,
  },
  {
    sourceKey: 'eternia-lyris-grayskull',
    worldSourceKey: 'eternia',
    title: 'Eternia 01 — Lyris at Castle Grayskull',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c4812e96abcd437d24b398',
    content: String.raw`I am Lyris. Ward of Castle Grayskull. Protégé of the Sorceress. I enter by choice, remain by choice, and return by choice.
...
## Sleep Script
*I am Lyris. The moons are through the window. The plants are blooming. The wolf is at the door. The snake watches. Grayskull holds around me, old and vast. The Sorceress keeps watch. My staff is coming. I do not know when. Grayskull knows. I am home and the castle knows my name.*`,
  },
  {
    sourceKey: 'recreators-canon-source-ingest',
    worldSourceKey: 'recreators',
    title: 'Re:CREATORS — Canon Source Ingest',
    status: 'Draft I',
    kind: 'source-ingest',
    revisedAt: '2026-07-23',
    sourceType: 'Source ingest / reference foundation',
    creator: 'Rei Hiroe; TROYCA; Ei Aoki; source references credited in Notion',
    reviewStatus: 'In review',
    canonBoundary: 'Source-derived foundation feeding the living Desired Reality build. Protagonist, arrival point, relationship structure, and canon divergence remain open authored fields.',
    summary: 'Creator and Created ontology, manifestation, revision, audience acceptance, distributed authorship, autonomy, genre collision, and return.',
    sourceUrl: 'https://app.notion.com/p/3a670290d9c48143864ad5e72bfe36b2',
    content: String.raw`## Ingest status
**Record type:** source ingest / reference script foundation

**Canon state:** source-derived foundation inside the living Desired Reality build
...
## Open authoring fields
Protagonist, arrival point, relationship structure, and canon divergence remain open for Steward authorship. The build includes a character registry, Creator/Created graph, manifestation timeline, acceptance-power notes, and Arrival and Sleep Scripts.
...
## Review gate
Source URL, production source, work identity, premise, ontology, figures, mechanics queue, and thematic labels are present. Episode-level extraction, character/world pages, protagonist, adaptation point, Arrival Scene, and Sleep Script remain pending.`,
  },
];
