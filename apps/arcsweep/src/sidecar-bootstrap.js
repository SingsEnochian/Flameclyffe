...
const SIDECAR_PACKS = Object.freeze({
  ...
  house: Object.freeze([
    './model-presence-bus.js','./runtime-presence-diagnostics.js','./runtime-integration-bootstrap.js','./constellation-runtime-adapter.js','./devconsole-swarm-chat.js','./house-commons-chat-v5.js','./house-chat-runtime-roster-ui.js','./house-braid-receipt-ui.js','./house-browser-smoke.js','./house-roleplay-mode.js','./formatted-text-vestments.js','./house-lanternbridge-chat.js','./house-commons-command-room.js','./house-commons-thread-restoration.js','./house-commons-deep-link-router.js','./constellation-presence.js','./runtime-world-presence.js',
  ]),
