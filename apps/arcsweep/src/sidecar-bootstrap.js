...
// Vite cannot discover `import(specifier)` when specifier is only known at runtime.
// Keeping this explicit glob list makes each registered organ a build-time dependency
// while preserving sequential, failure-contained mounting at runtime.
...
export { SIDECARS, SIDECAR_LOADERS };
