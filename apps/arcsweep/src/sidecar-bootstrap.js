...
const SIDECAR_PACKS = Object.freeze({
  ...
  house: Object.freeze([
    './model-presence-bus.js','./runtime-presence-diagnostics.js','./runtime-integration-bootstrap.js','./constellation-runtime-adapter.js','./hosted-house-session-ui.js','./house-chat-authoritative-surface.js','./devconsole-swarm-chat.js','./house-commons-chat-v5.js','./house-chat-runtime-roster-ui.js','./house-braid-receipt-ui.js','./house-browser-smoke.js','./house-roleplay-mode.js','./formatted-text-vestments.js','./house-commons-attachments.js','./house-chat-v5-compat.js','./house-chat-room-management-v5.js','./house-chat-room-social.js','./house-chat-tools-v5.js','./house-chat-vestments-v1.js','./house-chat-pretty-v2.js','./house-chat-pretty-v3.js','./runtime-envelope-live-ui.js','./model-presence-live-ui.js','./model-reply-proof.js','./house-lanternbridge-chat.js','./house-commons-command-room.js','./house-commons-thread-restoration.js','./house-commons-deep-link-router.js','./constellation-presence.js','./runtime-world-presence.js',
  ]),
