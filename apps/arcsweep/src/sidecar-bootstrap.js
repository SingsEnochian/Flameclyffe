const GLOBAL_SIDECARS = Object.freeze([
  './os/bootstrap.js',
  './somatic-sidecar.js',
  './somatic-cartography-sidecar.js',
  './temporal-witness-sidecar.js',
  './time-room-sidecar.js',
  './ancestry-sidecar.js',
  ...
  './magic-book-sound-bank-bridge.js',
...
const SIDECAR_PACKS = Object.freeze({
  ...
  house: Object.freeze([
    './model-presence-bus.js','./runtime-presence-diagnostics.js','./runtime-integration-bootstrap.js','./constellation-runtime-adapter.js','./devconsole-swarm-chat.js','./house-commons-chat-v5.js','./house-chat-runtime-roster-ui.js','./house-braid-receipt-ui.js','./house-browser-smoke.js','./house-roleplay-mode.js','./formatted-text-vestments.js','./house-lanternbridge-chat.js','./house-commons-command-room.js','./house-commons-thread-restoration.js','./house-commons-deep-link-router.js','./house-commons-attachments.js','./house-chat-v5-compat.js','./house-chat-room-management-v5.js','./house-chat-tools-v5.js','./runtime-envelope-live-ui.js','./model-presence-live-ui.js','./model-reply-proof.js','./constellation-presence.js','./runtime-world-presence.js',
  ]),
...
const SIDECAR_LOADERS = import.meta.glob([
  './os/bootstrap.js','./somatic-sidecar.js','./somatic-cartography-sidecar.js','./temporal-witness-sidecar.js','./time-room-sidecar.js','./ancestry-sidecar.js','./os-navigation-driver.js','./glyphforge-os-sidecar.js','./hosted-house-session-ui.js','./house-chat-authoritative-surface.js','./caretaker-sidecar.js','./observer-bridge.js','./feedback-queue-bootstrap.js','./rich-text-core.js','./soundfont-runtime-repair.js','./magic-book-sound-bank-bridge.js','./active-input-continuity.js','./mobile-navigation-sidecar.js','./creative-organ-navigation.js','./sound-organ-navigation.js','./semantic-lab-sidecar.js','./semantic-lab-v2-sidecar.js','./bluebird-lab-sidecar.js','./sidecar-health-panel.js','./magic-book-sidecar.js','./magic-book-physical-acceptance-entry.js','./world-registry-persistence-sidecar.js','./terra-prime-truth-sidecar.js','./instrument-console-sidecar.js','./instrument-sidecars.js','./react-ion-helm-sidecar.js','./glyph-drift-observatory-sidecar.js','./continuity-evidence-sidecar.js','./continuity-experiment-sidecar.js','./constellation-runtime-adapter.js','./model-presence-bus.js','./model-presence-live-ui.js','./model-reply-proof.js','./runtime-presence-diagnostics.js','./runtime-integration-bootstrap.js','./devconsole-swarm-chat.js','./house-commons-chat-v5.js','./house-chat-runtime-roster-ui.js','./house-braid-receipt-ui.js','./house-browser-smoke.js','./house-roleplay-mode.js','./formatted-text-vestments.js','./house-lanternbridge-chat.js','./house-commons-command-room.js','./house-commons-thread-restoration.js','./house-commons-deep-link-router.js','./house-commons-attachments.js','./house-chat-v5-compat.js','./house-chat-room-management-v5.js','./house-chat-room-social.js','./house-chat-tools-v5.js','./house-chat-vestments-v1.js','./house-chat-pretty-v2.js','./house-chat-pretty-v3.js','./runtime-envelope-live-ui.js','./canon-intelligence-live-ui.js','./constellation-presence.js','./runtime-world-presence.js','./self-authorship-panel.js','./script-cortex-controls.js','./scene-cognition-ui.js','./worldseed-live-ui.js','./possible-worlds-live-ui.js','./worldseed-package-live-ui.js','./worldseed-threshold-live-ui.js','./worldseed-braid-live-ui.js','./worldseed-seed-library-live-ui.js','./canon-web-link-sidecar.js','./feedback-chamber-v2.js','./story-mode-sidecar.js','./aemeth-chamber-live.js','./aemeth-oa-route-status.js',
]);
...
const ROOM_PACKS = Object.freeze({ worlds:['worlds'], scripts:['writing'], records:['writing'], feedback:['feedback'], commons:['house'], forge:['forge'], 'deep-observer':['deep'], seedhouse:['worldseed'], ingest:['canon'], timeline:['deep'], scenarios:['writing'], 'aemeth-lens':['aemeth'], 'time-room':['worlds'] });
