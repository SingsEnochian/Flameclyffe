export const TAAVEREN_VAEN_CANON_OVERLAY = Object.freeze({
  ...
  revised_at: '2026-08-19T08:19:00.000Z',
  world_source_key: 'taveren-vaen',
  canonical_name: 'Kestrelle al’Valari',
  ...
  authority: Object.freeze({
    ...
    old_kestrelle_alvar_name_is_superseded: true,
  }),
});

const CURRENT_CANON_NOTE = `## Current canon overlay · 2026-08-19

**Kestrelle al’Valari** is the canonical protagonist name. **Kestrelle al’Var** and earlier working names remain provenance only.
...
function replaceCurrentName(text = '') {
  return String(text)
    .replaceAll('Kestrelle al’Var', 'Kestrelle al’Valari')
    .replace(
      /The earlier working titles Ta’veren Bound and Ta’veren Unbound, and the earlier protagonist names Ayrel al’Valsora and Kestrelle al’Valari, are provenance only\./g,
      'The earlier working titles Ta’veren Bound and Ta’veren Unbound, and the earlier protagonist name Ayrel al’Valsora, are provenance only.',
    );
}
...
function overlayDocument(document) {
  ...
  return Object.freeze({
    ...document,
    title: isKestrelle ? 'Ta’veren Vaen 01 — Kestrelle al’Valari' : document.title,
