export const FOUNDATION_WORLD = {
  sourceKey: 'hearthweave-foundation',
  name: 'Hearthweave Foundation & Laboratory',
  kind: 'Threshold Architecture',
  protagonist: 'Rowan / world-specific protagonist',
  roles: 'Steward; worldbuilder; traveller by choice',
  description: 'The shared architecture beneath every Desired Reality: identity, consent, access, continuity, discernment, reception, and return.',
  history: 'Authored in the Shifting Wiki and Desired Reality Scripts database, then deliberately installed into Arcsweep by Steward decision on 2026-07-26.',
  rules: 'I enter by choice, remain by choice, and return by choice. Draft, In Review, Canon, and non-canon source material remain distinct.',
  revisedAt: '2026-07-26',
  sourceUrls: [
    'https://app.notion.com/p/3a070290d9c4815ab3efe43abd3d4084',
    'https://app.notion.com/p/3a470290d9c481a79412dbfe56ca3d26',
    'https://app.notion.com/p/3a770290d9c4818a9097c53f5fd1377a',
  ],
};

export const FOUNDATION_DOCUMENTS = [
  {
    sourceKey: 'shifting-wiki-shared-foundation',
    worldSourceKey: 'hearthweave-foundation',
    title: 'Shifting Wiki — Shared Foundation',
    status: 'Canon',
    formats: ['Reference Script'],
    kind: 'foundation',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a070290d9c4815ab3efe43abd3d4084',
    content: String.raw`A private working codex for Desired Reality scripts across our established story-worlds. Each entry preserves the protagonist’s identity, the world’s canon, and the agency of everyone within it.
...
Drafts may grow through conversation; nothing becomes final canon merely because it has been written once.`,
  },
  {
    sourceKey: 'hearthweave-universal-dr-template',
    worldSourceKey: 'hearthweave-foundation',
    title: 'Hearthweave Universal Desired Reality Template',
    status: 'Canon',
    formats: ['Reference Script'],
...
This layer never overrides the Fixed Foundation. A Focus state, message, image, dream, sensation, or apparent contact cannot suspend identity, consent, accessibility, discernment, canon review, or return.`,
  },
  {
    sourceKey: 'gateway-practice-patterning-dr-creation',
    worldSourceKey: 'hearthweave-foundation',
    title: 'Gateway Practice, Patterning & Desired Reality Creation',
    status: 'In Review',
    formats: ['Reference Script'],
    kind: 'practice-layer',
    revisedAt: '2026-07-24',
    sourceUrl: 'https://app.notion.com/p/3a770290d9c4818a9097c53f5fd1377a',
    content: String.raw`A working bridge between the Gateway Experience, manifestation and patterning practices, and the Hearthweave method for designing Desired Realities.
...
- 07 — Gateway Source Ingest & Reading Ledger`,
  },
  {
    sourceKey: 'desired-reality-laboratory',
    worldSourceKey: 'hearthweave-foundation',
    title: 'Desired Reality Laboratory',
    status: 'Canon',
    formats: ['Reference Script'],
    kind: 'threshold-space',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c48031aeb3e3ef6edc670b',
...
All settings remain reversible unless I deliberately choose otherwise. No ability can erase my identity, judgement, empathy, memories, or capacity to return. Power does not create involuntary obedience, mania, addiction, cruelty, or detachment.`,
  },
  {
    sourceKey: 'desired-reality-laboratory-arrival-sleep',
    worldSourceKey: 'hearthweave-foundation',
    title: 'Desired Reality Laboratory — Arrival Scene & Sleep Script',
    status: 'Canon',
    formats: ['Arrival Scene', 'Sleep Script', 'Reference Script'],
    kind: 'threshold-practice',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c4813fb7efeac824a376c9',
    content: String.raw`The Desired Reality Laboratory is the threshold-world. It is where every session begins and every return ends: the space between worlds — cool, open, and wholly mine.
...
## Continuity log
After each session, note the world and arrival point, what was present or unexpected, what should resume, what should not repeat, anchors used, and integration notes.`,
  },
  {
    sourceKey: 'current-reality-anchor',
    worldSourceKey: 'hearthweave-foundation',
    ...
    kind: 'waking-anchor',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c481c5b8f2cdfb2cab70fc',
    content: String.raw`This is the Current Reality anchor for the Shifting Wiki: the Waking World branch of the same living house, written so that return always has a clear destination.
...
Notice the world returned from and how the Waking World differs. Record what should continue and what should not repeat. Drink water and eat if time has passed. Let every world remain exactly what it is; record what happened without sanding it into a preferred explanation.

## Return confidence
I always return. The Waking World is always here. My identity is continuous and mine. I come back because I choose to. That is the law I wrote for myself.`,
  },
  {
    sourceKey: 'universal-dr-blank-world-build',
    worldSourceKey: 'hearthweave-foundation',
    title: 'Universal Desired Reality Script — Blank World Build',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'blank-template',
    revisedAt: '2026-07-21',
    sourceUrl: 'https://app.notion.com/p/3a470290d9c481768ad6d7ad3dcdf95e',
    content: String.raw`I am [name / identity]. I enter by choice, remain by choice, and return by choice.
...
## Review
Identity, agency, accessibility, discernment, ability controls, meaningful conflict, time, memory, continuity, return, source credit, and deliberate review must all be explicit before Canon.`,
  },
  {
    sourceKey: 'world-reception-profile-universal',
    worldSourceKey: 'hearthweave-foundation',
    title: 'World Reception Profile — Universal Template',
    status: 'In Review',
    formats: ['Reference Script'],
    kind: 'reception-profile',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c481c09740db64fb5d2d1a',
    content: String.raw`## Purpose
...
## Calibration record
Before, during, and Withness-after observations remain separate. Change one variable at a time and record the old value, new value, reason, session result, and explicit approval.`,
  },
];
