...
function render(message = '') {
  ...
  return `<section class="panel reaction-world-tone-sync" data-reaction-world-tone-sync>
    <div class="section-heading compact-heading"><div><p class="eyebrow">Runa · approved World Tone bridge</p><h3>World Tone Sync</h3><p class="muted">Import approved human-calibrated World Tone roots into existing world-level dimensional registrations. The registry supplies the dimensional address; Runa supplies the harmonic profile.</p></div></div>
