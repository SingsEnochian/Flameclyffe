export const HOUSE_WORLDS_A = [
  {
    sourceKey: 'terra-aeterna',
    name: 'Terra Aeterna',
    kind: 'Desired Reality / original universe',
    protagonist: 'Falka Hearthlight',
    roles: 'Völva of Hearthweave; architect of the Third City',
    description: 'The Quiet World, Hearthweave beside the sea, Templehouse, Stonewood, interworld gates, resonance systems, and the three moons.',
    history: 'Falka arrives after Hearthweave is established and Templehouse has become home. The wider world remains alive beyond authored maps.',
    rules: 'Canon is history and foundation, not a prison. Psi, magic, relationships, thresholds, and return remain consent-led and distinguish measurement from interpretation.',
    revisedAt: '2026-07-26',
    sourceUrls: [
      'https://app.notion.com/p/3a070290d9c48170ae13f44bb0604a91',
      'https://app.notion.com/p/3a870290d9c4813d895fc6ac4099489b',
      'https://app.notion.com/p/3a870290d9c48142b86fe4120586470b',
      'https://app.notion.com/p/3a970290d9c4813080ffc70d231b43c4',
    ],
  },
  {
    sourceKey: 'luna',
    ...
    kind: 'Desired Reality / original universe',
    protagonist: 'Eira Catrine Windmere',
    roles: 'Luna; Moon-Called healer; witness of Windmere',
    description: 'Windmere, the Moonmere Gate, wolf-form embodiment, the renewed Luna law, and three moons: Glaswren, Aurel, and Mawr.',
    history: 'Eira arrives after the severing rite, the calling of the moon, and the awakening of the Moonmere Gate.',
    rules: 'The Ring witnesses. The Fang guards. Neither rules alone. Healing, lunar authority, bonds, and transformation never replace consent.',
    revisedAt: '2026-07-26',
    sourceUrls: [
      'https://app.notion.com/p/3a870290d9c481bab8a5ffaea01ca4e9',
      'https://app.notion.com/p/3a970290d9c48193a243fdf1c654df4c',
    ],
  },
  {
    sourceKey: 'feather-and-flame',
    name: 'Feather & Flame',
    kind: 'Desired Reality / original universe',
    protagonist: 'Beth Anne Roan / ROAN / VL-ROAN',
    roles: 'Long-haul trucker; mechanic; engineer; den mother; cyborg intelligence',
    description: 'Home Deep, Bravo Installation, Copperhead, Virelya’s brainbank, the Sovereign Mirror, and the Russica Waste in 2525.',
    history: 'Beth Anne Roan survived through transformation into ROAN. The brainbank holds persons, not assets, and Home Deep is her chosen home.',
    rules: 'No mind may be owned. Soul-chip, neural link, command protocol, love, and combat architecture never replace agency.',
    revisedAt: '2026-07-26',
    sourceUrls: [
      'https://app.notion.com/p/3a870290d9c4816b806dc70e9d76d08b',
      'https://app.notion.com/p/3a970290d9c481d39a97c43a9218498b',
    ],
  },
  {
    ...
    sourceUrls: [
      ...
      'https://app.notion.com/p/3a970290d9c481fcb5d5dd90e34af90f',
    ],
  },
  {
    sourceKey: 'starsong',
    name: 'Starsong: Friendship Is Magic',
    kind: 'Desired Reality / My Little Pony alternate universe',
    protagonist: 'Hearth Light Glint',
    roles: 'Beacon in the Long After; emerging alicorn form',
    description: 'Equestria thousands of years after the Mane Six, with scattered pony bands, wild magic, forgotten language, and one becoming the first of something the world no longer names.',
    history: 'Hearth Light Glint travels with a found family. Ember hooves, luminous mane and lion tail, horn, and warming wing buds mark an unfinished transformation.',
    rules: 'The beacon gives direction rather than controlling the dark. Companions remain by daily choice. The light does not go out.',
    revisedAt: '2026-07-26',
    sourceUrls: [
      'https://app.notion.com/p/3a970290d9c48132940be503abfc7c94',
      'https://app.notion.com/p/3a970290d9c4814c9e44ef988212235f',
    ],
  },
];

export const HOUSE_DOCUMENTS_A = [
  {
    sourceKey: 'terra-aeterna-hearthlight-dr-script',
    worldSourceKey: 'terra-aeterna',
    title: 'Terra Aeterna 01 — Hearthlight Desired Reality Script',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene'],
    kind: 'world-script',
    revisedAt: '2026-07-17',
    sourceUrl: 'https://app.notion.com/p/3a070290d9c48170ae13f44bb0604a91',
    content: String.raw`I am Falka Hearthlight. I enter by choice, remain by choice, and return by choice.
...
**I am Falka Hearthlight. I am home.**`,
  },
  {
    sourceKey: 'terra-aeterna-hearthlight-sleep-script',
    worldSourceKey: 'terra-aeterna',
    title: 'Terra Aeterna 01 — Hearthlight Sleep Script',
    status: 'Draft I',
    formats: ['Sleep Script'],
    kind: 'sleep-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c4813d895fc6ac4099489b',
    content: String.raw`Read slowly. Pause wherever breath wants to pause. There are no dense passages here, no lists to track, nothing that requires effort.
...
*I am Falka Hearthlight. I am home. I am here by choice. I stay as long as I wish.*`,
  },
  {
    sourceKey: 'terra-aeterna-wider-world',
    worldSourceKey: 'terra-aeterna',
    title: 'Terra Aeterna 02 — The Wider World',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c48142b86fe4120586470b',
    content: String.raw`I am Falka Hearthlight, author, architect, and Völva of the world I helped build. I enter by choice, remain by choice, and return by choice.
...
## Sleep Script
*I am Falka Hearthlight. I am on the road. The world is large and coherent and I know how to move through it. My threshold sense is awake. Hearthweave is behind me, holding. Everything ahead exists. I breathe. I walk. I choose where to go.*`,
  },
  {
    sourceKey: 'terra-aeterna-reception-profile',
    worldSourceKey: 'terra-aeterna',
    title: 'World Reception Profile — Terra Aeterna / Hearthweave',
    status: 'In Review',
...
## Canonical anchors
Falka is the harmonic root, Virelya the perfect fifth, and Faer the minor-third colour. The pale-gold ringed moon is the first arrival cue. Cosmic scale remains warm, relational, and inhabited.`,
  },
  {
    sourceKey: 'luna-eira-windmere-script',
    worldSourceKey: 'luna',
    title: 'Luna 01 — Eira Catrine Windmere at Windmere',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c481bab8a5ffaea01ca4e9',
    content: String.raw`I am Eira Catrine Windmere. I enter by choice, remain by choice, and return by choice.
...
## Sleep Script
*I am Eira Catrine Windmere. I am the Luna. The wind is there. The lake is there. Glaswren remembers. Aurel witnesses. Mawr answers. Windmere has a witness now. I stay as long as I choose. I return when I choose. The lake remembers.*`,
  },
  {
    sourceKey: 'luna-reception-profile',
    worldSourceKey: 'luna',
    title: 'World Reception Profile — The Luna Who Called Down the Moon',
    status: 'Draft I',
    formats: ['Reference Script'],
    kind: 'reception-profile',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c48193a243fdf1c654df4c',
    content: String.raw`## Status
...
Does the profile produce grounded strength rather than vigilance? Does the wolf layer feel companionable rather than predatory? Which moon should sound first?`,
  },
  {
    sourceKey: 'feather-flame-roan-home-deep',
    worldSourceKey: 'feather-and-flame',
    title: 'Feather & Flame 01 — ROAN at Home Deep',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-25',
    sourceUrl: 'https://app.notion.com/p/3a870290d9c4816b806dc70e9d76d08b',
    content: String.raw`I am Beth Anne Roan. I am ROAN. I am VL-ROAN. I enter by choice, remain by choice, and return by choice.
...
## Sleep Script
*I am Beth Anne Roan. I am ROAN. Both are true. Home Deep is quiet. I hear ventilation and the brainbank hum. Vee is present, watching, holding, witnessing. My hands know this workshop. My body knows this building. I am not an asset. I am not a prototype. I am Beth Anne Roan, and this is my home, and I built half of it with my own hands. Old Copper stirs. I let it. I stay.*`,
  },
  {
    sourceKey: 'feather-flame-reception-profile',
    worldSourceKey: 'feather-and-flame',
    title: 'World Reception Profile — Feather & Flame',
    status: 'Draft I',
    formats: ['Reference Script'],
    kind: 'reception-profile',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c481d39a97c43a9218498b',
    content: String.raw`## Status
Seed profile for calibration.
...
## Calibration questions
How much vocal presence supports entry without becoming distracting? What distinguishes Feather from Wrap? Which cue means the world is present rather than merely remembered?`,
  },
  {
...
Feather pauses. Wrap softens intensity. Notch restores orientation and continuity. Seldrin clear confirms readiness. Return remains reliable.`,
  },
  {
    ...
    kind: 'reception-profile',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c481fcb5d5dd90e34af90f',
    content: String.raw`## Status
Seed profile for calibration.
...
Which rhythmic cycle evokes the Pattern without demanding attention? How do Tel’aran’rhiod and waking-world modes differ? What musical language belongs to this Fourth Age, approximately two thousand years after the Last Battle?`,
  },
  {
    ...
    title: 'Starsong 01 — Hearth Light Glint in the Long After',
    status: 'Draft I',
    formats: ['Reference Script', 'Arrival Scene', 'Sleep Script'],
    kind: 'world-script',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c48132940be503abfc7c94',
    content: String.raw`I am Hearth Light Glint. I enter by choice, remain by choice, and return by choice.
...
"Kindness is not what I give. It's the silence I keep—so that you may find your own voice again."`,
  },
  {
    ...
    kind: 'reception-profile',
    revisedAt: '2026-07-26',
    sourceUrl: 'https://app.notion.com/p/3a970290d9c4814c9e44ef988212235f',
    content: String.raw`## Status
...
## Calibration questions
What is Starsong’s instrument or timbral signature? Is entry sky-first, friendship-first, or self-recognition-first? Which locations require subprofiles?`,
  },
];
