...
import { createSourceLibraryHandler } from './source-library-runtime.mjs';
...
export async function runSourceLibraryLiveSmoke({ envAdapter, fetchImpl = fetch } = {}) {
  if (!envAdapter?.get) {
    throw typedError('HOSTED_CONFIGURATION_MISSING', 'Source Library live smoke requires a runtime environment adapter.');
  }
