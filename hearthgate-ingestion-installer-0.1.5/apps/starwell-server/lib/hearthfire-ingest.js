...
function createIngestStore({ dataDir, appRoot, maxFileBytes = 64 * 1024 * 1024 }) {
  ...
  return { ensure, firstLight, list, readExtractedText, ingestBuffer, ingestPath, supportedExtensions: [...SUPPORTED_EXTENSIONS], maxFileBytes, catalogPath };
}

module.exports = { createIngestStore, TEXT_EXTENSIONS, IMAGE_EXTENSIONS, SUPPORTED_EXTENSIONS };
